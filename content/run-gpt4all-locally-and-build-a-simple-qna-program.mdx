...
4. **Convert the model:** To convert it, you have to run the `convert.py` argument value `path-to-our-downloaded-model` So you can just move the model to `llama.cpp/models` the directory.
    ...
    ![terminal view while convert the model weight](https://cdn.hashnode.com/res/hashnode/image/upload/v1689158851633/614507a6-7aa8-4732-aae6-28b189c37524.png align="center")
...
6. **Running our program:** You can change the `q` variable to ask any question you want. Try out different questions, and see our this model performs on your machine. I have an MBA 8GB with 256GB SDD, and I still think a 16GB version would do a lot better in terms of faster output generation time.
    ...
    ![running the gpt4all program](https://cdn.hashnode.com/res/hashnode/image/upload/v1689159222633/2405ba6c-daf5-43c8-aa3d-e91fbd325b7e.png align="center")
...
7. **Understanding the Output:** Let us see the output first.
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1689159395049/78baba20-73d3-48cb-9d45-b34068e1a239.png align="center")
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1689159898658/fb66afba-862b-4663-9017-df29b9d47926.png align="center")

...
readTimeInMinutes: 6
views: 258
tags: ["API Development", "Low-code", "Tutorial"]
coverImage:
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690983677347/fd46e81c-9255-4f90-a1e6-03a23a278fac.webp)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690975819557/aae1e9b0-02be-4344-94af-2e6c2d167f38.png)
...
1. **Create an account with Syncloop:**
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690976164515/b8903325-da64-40c8-ad48-d65b712433f8.png)
...
2. **Head over to Workspace:**
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690976392616/a4ed8b8a-fc28-4b89-afc9-c115903a21cb.png)
...
3. **Create the folders and files:**
    ...
    **Second**, you'll see the new package `quoteAPI` with a dependency folder inside it. Now create a folder there. I'm naming it `generateQuotes`
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690978885894/9e4201a2-f02f-4c9f-bc95-ff2e0f8b3149.png)
    ...
    **Third**, create a last file which is a service of the API category. And in this file, we will drag and drop stuff to make the quote generation work.
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690979061341/a9084698-4448-4abb-b7cf-d67f7fc8368e.png)
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690979350732/1ecdc7a5-d364-4be7-9751-e12155ef3d6a.png)
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690980052930/a0cb7c9a-a214-4beb-916f-75a9aa3c2ba1.png)
...
4. **Build API Service File:**
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690980535925/eede4edc-09f5-4636-b052-7bb66acbd674.png)
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690980823366/94873247-c009-4153-a722-bbc3f8b9991d.png)
    ...
    **Second**, right-click on the dashboard area and this time select a service and this popup will arise. So without interfering with the pop-up, search in the packages section with '*request',* select the *requestV2* and click on Done.
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690981069026/a4f6374f-48b8-4f48-ba95-372e936518e4.png)
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690981361311/78594a5a-104a-41b0-8ffa-c940815bc99b.png)
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690981649891/870a8f87-25c8-417a-8100-f677f438cab3.png)
    
5. **Now let's test our API with Postman:**
    
    Before that, extract our API's endpoint by clicking on the configuration icon.
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690981724721/c5e80f00-045a-4e52-a237-ba841b1d41f4.png)
    
    And, get the bearer token from the sidebar,
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690981821588/f844cb8c-4098-40c9-8695-b0f95369f587.png)
    
    Now, just put the endpoint of the token in Postman and perform a *GET* request.
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690982000752/5b6fba6d-f1fd-4e52-ae71-f9698556b4ec.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690983561489/ea69bd84-0910-4eb1-9969-c0fe00ade9ca.webp)
